							...
							<div class="inner-body mailbox-email">
								<div class="mailbox-email-header mb-lg">
									<h3 class="mailbox-email-subject m-none text-light">
										Released Porto Admin! (3) <!--/*/*title here-->
									</h3>
							
									<p class="mt-lg mb-none text-md">From <a href="#">Okler Themes<!--/*from--></a> to <a href="#">You</a>, July, 05, 2014<!--/*date start--></p>
								</div>
									...
									<div class="mailbox-email-screen">
										<div class="panel">
											<div class="panel-heading">
												...
												<p class="panel-title">Okler Themes<!--/*from--> <i class="fa fa-angle-right fa-fw"></i> You<!--/*to--></p>
											</div>
											...
											<div class="panel-footer">
												<p class="m-none"><small>July 07, 2014. 9:51pm<!--/*date sent--></small></p>
											</div>
										</div>
