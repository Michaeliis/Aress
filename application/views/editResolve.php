...
<?php foreach($msgInfo as $msgInfos){
    ...
    <p class="text-right">
        <a onclick="document.forms['form'].submit();" class="btn btn-primary">Assign</a>
        <a href="<?= base_url('incident/resolve/'). $msgId?>" class="btn btn-danger">Cancel</a>
    </p>
    ...
    <form id="form" name="form" action="<?= base_url('incident/editResolve/'). $msgId?>" method="post">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="impact" name="impact"  class="form-control mb-md" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="urgency" name="urgency"  class="form-control mb-md" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="priority" name="priority" class="form-control mb-md" required>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="team" name="team"  class="form-control mb-md" value="<?= $msgCategory?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="agent" name="agent"  class="form-control mb-md"  value="<?= $msgReceiver?>" required>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="col-md-4">
            <section class="panel">
                ...
                <div class="panel-body">
                    <textarea type="text" id="resolution" name="resolution"  class="form-control mb-md" rows="4" required></textarea>
                </div>
            </section>
        </div>
