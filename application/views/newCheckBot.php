            ...
            <div class="panel-body">
                <form class="form-horizontal form-bordered" action="<?= base_url('bot/check')?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="category" name="appToken" value="<?= $_SESSION['appToken']?>" class="form-control mb-md" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea name="message" rows="4" class="form-control mb-md" required></textarea>
                        </div>
                    </div>
