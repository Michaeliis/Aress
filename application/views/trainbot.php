...
function addRow(tableID) {
	...
	if(rowCount < 20){                            // limit the user from creating fields more than your limits
        ...
        newcell.innerHTML = '<select name="entity[]" class="form-control" placeholder="Entity" param='+(rowNum)+' onchange="valueSet(this)" required><option value="">Select Entity</option><?php foreach($entity as $entities){?><option value="<?= $entities->entity?>"><?= $entities->entity?></option><?php } ?></select>';
